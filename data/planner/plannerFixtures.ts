...
export const curatedRoast: NormalizedRecipe = {
  ...
  activePrepMinutes: 15, totalMinutes: 90, complexityScore: 3, cleanupBurden: 'Medium',
...
export const curatedPasta: NormalizedRecipe = {
  ...
  activePrepMinutes: 5, totalMinutes: 15, complexityScore: 2, cleanupBurden: 'Medium',
...
export const generatedLentilStew: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 35, complexityScore: 2, cleanupBurden: 'Medium',
...
export const highProteinSeitan: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 40, complexityScore: 3, cleanupBurden: 'Medium',
...
export const highProteinTempeh: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 20, complexityScore: 2, cleanupBurden: 'Medium',
...
export const highProteinHalloumi: NormalizedRecipe = {
  ...
  activePrepMinutes: 5, totalMinutes: 30, complexityScore: 2, cleanupBurden: 'Medium',
...
export const veganTikkaMasala: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 30, complexityScore: 3, cleanupBurden: 'Medium',
...
export const veganMeatloaf: NormalizedRecipe = {
  ...
  activePrepMinutes: 15, totalMinutes: 50, complexityScore: 3, cleanupBurden: 'Medium',
...
export const veganOvernightOats: NormalizedRecipe = {
  ...
  activePrepMinutes: 5, totalMinutes: 480, complexityScore: 2, cleanupBurden: 'Medium',
...
export const veganTempehBowl: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 25, complexityScore: 2, cleanupBurden: 'Medium',
...
export const veggieShells: NormalizedRecipe = {
  ...
  activePrepMinutes: 15, totalMinutes: 40, complexityScore: 3, cleanupBurden: 'Medium',
...
export const veggieFetaWrap: NormalizedRecipe = {
  ...
  activePrepMinutes: 10, totalMinutes: 10, complexityScore: 2, cleanupBurden: 'Medium',
...
export const pesciSeabass: NormalizedRecipe = {
  ...
  activePrepMinutes: 5, totalMinutes: 20, complexityScore: 3, cleanupBurden: 'Medium',
