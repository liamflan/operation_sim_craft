 ...
 * Phase 21: Updated with cuisine-led metadata.
 * Retains flavorIds, styleIds, ingredientTags, difficulty and time.
 */
export const MOCK_RECIPES: any[] = [
  {
    ...
    cuisineId: "japanese",
    flavourIds: ["umami", "soy", "ginger"],
    styleIds: ["clean", "rice"],
    ingredientTags: ["fish", "soy", "miso"],
  ...
  },
  {
    ...
    cuisineId: "french",
    flavourIds: ["rich", "garlic"],
    styleIds: ["refined_comfort"],
    ingredientTags: ["beef", "butter"],
  ...
  },
  {
    ...
    flavourIds: ["fresh", "lemon"],
    styleIds: ["light", "fresh"],
    ingredientTags: ["avocado", "egg", "sourdough"],
  ...
  },
  {
    ...
    cuisineId: "french",
    flavourIds: ["garlic", "rich"],
    styleIds: ["refined_comfort"],
    ingredientTags: ["chicken", "spinach", "butter"],
    archetype: 'High_Protein',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "mediterranean",
    flavourIds: ["lemon", "herbs", "olive_oil"],
    styleIds: ["light", "fresh"],
    ingredientTags: ["quinoa", "avocado", "tomato"],
    archetype: 'Variety_Pack',
    suitableFor: ['lunch'],
  ...
  },
  {
    ...
    cuisineId: "chinese",
    flavourIds: ["soy", "ginger", "garlic"],
    styleIds: ["stir_fry"],
    ingredientTags: ["beef", "broccoli", "soy_sauce"],
    archetype: 'Variety_Pack',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "mexican",
    flavourIds: ["cumin", "lime", "smoky"],
    styleIds: ["clean"],
    ingredientTags: ["black_beans", "sweet_potato", "spinach"],
    archetype: 'Variety_Pack',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "mexican",
    flavourIds: ["chilli", "cumin", "smoky"],
    styleIds: ["braised"],
    ingredientTags: ["turkey", "chilli", "beans"],
  ...
  },
  {
    ...
    cuisineId: "italian",
    flavourIds: ["tomato", "basil", "garlic"],
    styleIds: ["pasta", "fresh_comfort"],
    ingredientTags: ["chicken", "parmesan", "mozzarella"],
    archetype: 'Variety_Pack',
    suitableFor: ['dinner'],
    estimatedCostGBP: 4.50,
    ingredients: [
  ...
  },
  {
    ...
    cuisineId: "italian",
    flavourIds: ["basil", "garlic", "olive_oil"],
    styleIds: ["pasta"],
    ingredientTags: ["chicken", "parmesan", "basil"],
    archetype: 'High_Protein',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "chinese",
    flavourIds: ["soy", "ginger", "sesame"],
    styleIds: ["stir_fry", "rice"],
    ingredientTags: ["egg", "rice", "soy_sauce"],
    archetype: 'budget_workhorse',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "indian",
    flavourIds: ["curry", "warming_spice", "aromatic"],
    styleIds: ["saucy"],
    ingredientTags: ["lentils", "turmeric", "coconut_milk"],
    archetype: 'budget_workhorse',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    cuisineId: "mexican",
    flavourIds: ["chilli", "cumin", "garlic"],
    styleIds: ["stew"],
    ingredientTags: ["beef", "beans", "chilli"],
    archetype: 'budget_workhorse',
    suitableFor: ['lunch', 'dinner'],
  ...
  },
  {
    ...
    flavourIds: ["lime", "chilli"],
    styleIds: ["fragrant_herbs", "rice"],
  ...
  },
  {
    ...
    flavourIds: ["fresh", "lemon"],
    styleIds: ["light"],
    ingredientTags: ["avocado", "sourdough"],
    archetype: 'budget_breakfast',
    suitableFor: ['breakfast'],
