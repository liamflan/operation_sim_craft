              ...
              <View className="bg-surface dark:bg-darkgrey/60 rounded-[32px] p-7 mb-8 border border-softBorder dark:border-white/5 shadow-sm backdrop-blur-md">
                ...
                <View className="flex-row justify-between items-center mb-6 border-b border-softBorder dark:border-white/5 pb-6">
                  ...
                  <TouchableOpacity 
                    ...
                    className="bg-primary/10 px-5 py-2.5 rounded-2xl active:bg-primary/20"
                  >
                ...
                <View className="flex-row justify-between items-center mb-6 border-b border-softBorder dark:border-white/5 pb-6">
                  ...
                  <TouchableOpacity 
                    ...
                    activeOpacity={0.7}
                    className="bg-primary/10 px-5 py-2.5 rounded-2xl active:bg-primary/20 flex-row items-center"
                  >
            ...
            <View className="md:flex-1">
              ...
              <View className="mt-8">
                ...
                <TouchableOpacity 
                  ...
                  className="bg-surface dark:bg-darkgrey border-2 border-danger/10 p-5 rounded-[24px] items-center active:bg-danger/5"
                >
      ...
      <Modal visible={editingDiet} transparent={true} animationType="fade">
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 justify-center items-center bg-black/40 dark:bg-black/60 p-4">
          <View className="bg-surface dark:bg-darksurface w-full max-w-[340px] rounded-[32px] p-8 shadow-xl border border-black/[0.05] dark:border-darksoftBorder">
            ...
            <View className="flex-col gap-2">
              {['Omnivore', 'Pescatarian', 'Vegetarian', 'Vegan'].map(option => (
                <TouchableOpacity 
                  ...
                  className={`py-4 px-5 rounded-[20px] border ${diet === option ? 'bg-primary border-primary shadow-sm' : 'bg-black/[0.02] dark:bg-white/[0.02] border-black/[0.04] dark:border-white/5 hover:bg-black/[0.04] dark:hover:bg-white/[0.04]'}`}
                >
            ...
            <View className="mt-8">
              <TouchableOpacity activeOpacity={0.7} onPress={() => setEditingDiet(false)} className="w-full py-4 rounded-full border border-black/10 dark:border-white/10 items-center justify-center hover:bg-black/5 dark:hover:bg-white/5">
      ...
      <Modal visible={editingBudget} transparent={true} animationType="fade">
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 justify-center items-center bg-black/40 dark:bg-black/60 p-4">
          <View className="bg-surface dark:bg-darksurface w-full max-w-[340px] rounded-[32px] p-8 shadow-xl border border-black/[0.05] dark:border-darksoftBorder">
            ...
            <View className="flex-row items-center justify-center bg-black/[0.02] dark:bg-white/[0.02] p-6 rounded-[24px] border border-black/[0.04] dark:border-white/5 focus-within:border-black/10 dark:focus-within:border-white/10">
            ...
            <View className="flex-row gap-2 mt-8">
              <TouchableOpacity activeOpacity={0.7} onPress={() => setEditingBudget(false)} className="flex-1 py-3.5 rounded-full border border-black/10 dark:border-white/10 items-center justify-center hover:bg-black/5 dark:hover:bg-white/5">
                <Text className="text-textSec dark:text-darktextSec font-medium text-[14px]">Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={0.8} onPress={saveBudget} className="flex-1 bg-primary py-3.5 rounded-full items-center justify-center shadow-sm hover:bg-primary-hover">
      ...
      <Modal visible={editingCalories} transparent={true} animationType="fade">
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 justify-center items-center bg-black/40 dark:bg-black/60 p-4">
          <View className="bg-surface dark:bg-darksurface w-full max-w-[340px] rounded-[32px] p-8 shadow-xl border border-black/[0.05] dark:border-darksoftBorder">
            ...
            <View className="flex-row gap-2 mt-8">
              <TouchableOpacity activeOpacity={0.7} onPress={() => setEditingCalories(false)} className="flex-1 py-3.5 rounded-full border border-black/10 dark:border-white/10 items-center justify-center hover:bg-black/5 dark:hover:bg-white/5">
                <Text className="text-textSec dark:text-darktextSec font-medium text-[14px]">Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity activeOpacity={0.8} onPress={saveCalories} className="flex-1 bg-primary py-3.5 rounded-full items-center justify-center shadow-sm hover:bg-primary-hover">
                <Text className="text-white font-medium text-[14px]">Save</Text>
              </TouchableOpacity>
            </View>
          </View>
